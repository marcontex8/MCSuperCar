...
namespace carPack001{
	...
	const std::string carPack_path = R"(D:\WorkSpace\MCSuperCar\Modules\world_viewer\graphic\CarPack001\)";
	const std::string opticsTexture_path = R"(D:\WorkSpace\MCSuperCar\Modules\world_viewer\graphic\CarPack001\Textures\Optics.jpg)";
